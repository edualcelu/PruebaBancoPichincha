...
public class Account implements Serializable {
   ...
   */
  public Account(String number, String type, BigDecimal initialBalance, String status, String customerId) {
    this.number = number;
    this.type = type;
  ...
  */
  ...
  @Schema(name = "number", description = "Número de cuenta único (PK)", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("number")
